...
class ActivationAPIControllerImplTest {
  ...
  @MockBean private ActivationDBRepository activationDBRepository;

  @MockBean private ActivationPayerService activationPayerService;

  @MockBean private ActivationDtoMapper activationDtoMapper;

  @Autowired private ActivationPropertiesConfig activationPropertiesConfig;
  ...
  void testFindActivationByPayerIdSuccess() {
    ...
    when(activationPayerService.findPayer(payerDto.getFiscalCode())).thenReturn(Mono.just(payer));
