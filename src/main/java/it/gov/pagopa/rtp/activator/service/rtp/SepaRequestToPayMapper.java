...
public class SepaRequestToPayMapper {
  ...
  public SepaRequestToPayRequestResourceDto toRequestToPay(Rtp rtp) {
    ...
    SepaRequestToPayRequestResourceDto sepaRequestToPayRequestResourceDto =
        new SepaRequestToPayRequestResourceDto();

    PartyIdentification135EPC25922V30DS02Dto partyIdentification135EPC25922V30DS02Dto =
        new PartyIdentification135EPC25922V30DS02Dto();
    partyIdentification135EPC25922V30DS02Dto.setNm("PagoPA"); // FIXED

    GroupHeader105EPC25922V30DS02Dto groupHeader105EPC25922V30DS02Dto =
        new GroupHeader105EPC25922V30DS02Dto();
    ...
    ExternalPersonIdentification1CodeEPC25922V30DS02WrapperDto
        externalPersonIdentification1CodeEPC25922V30DS02WrapperDto =
            new ExternalPersonIdentification1CodeEPC25922V30DS02WrapperDto();
    externalPersonIdentification1CodeEPC25922V30DS02WrapperDto.cd(
        ExternalPersonIdentification1CodeEPC25922V30DS02Dto.POID);

    GenericPersonIdentification1EPC25922V30DS02Dto genericPersonIdentification1EPC25922V30DS02Dto =
        new GenericPersonIdentification1EPC25922V30DS02Dto(rtp.payerId());
    genericPersonIdentification1EPC25922V30DS02Dto.setSchmeNm(
        externalPersonIdentification1CodeEPC25922V30DS02WrapperDto);

    List<GenericPersonIdentification1EPC25922V30DS02Dto>
        lGenericPersonIdentification1EPC25922V30DS02Dtos = new ArrayList<>();
    lGenericPersonIdentification1EPC25922V30DS02Dtos.add(
        genericPersonIdentification1EPC25922V30DS02Dto);

    PersonIdentification13EPC25922V30DS02Dto personIdentification13EPC25922V30DS02Dto =
        new PersonIdentification13EPC25922V30DS02Dto();
    personIdentification13EPC25922V30DS02Dto.setOthr(
        lGenericPersonIdentification1EPC25922V30DS02Dtos);

    PersonIdentification13EPC25922V30DS02WrapperDto
        personIdentification13EPC25922V30DS02WrapperDto =
            new PersonIdentification13EPC25922V30DS02WrapperDto();
    personIdentification13EPC25922V30DS02WrapperDto.setPrvtId(
        personIdentification13EPC25922V30DS02Dto);
    ...
    partyIdentification135EPC25922V30DS022Dto.setId(
        personIdentification13EPC25922V30DS02WrapperDto);

    FinancialInstitutionIdentification18EPC25922V30DS02Dto
        dbtFinancialInstitutionIdentification18EPC25922V30DS02Dto =
    ...
    BranchAndFinancialInstitutionIdentification6EPC25922V30DS02Dto
        dbtBranchAndFinancialInstitutionIdentification6EPC25922V30DS02Dto =
            new BranchAndFinancialInstitutionIdentification6EPC25922V30DS02Dto();
    dbtBranchAndFinancialInstitutionIdentification6EPC25922V30DS02Dto.setFinInstnId(
        dbtFinancialInstitutionIdentification18EPC25922V30DS02Dto);

    PaymentIdentification6EPC25922V30DS02Dto paymentIdentification6EPC25922V30DS02Dto =
        new PaymentIdentification6EPC25922V30DS02Dto(
            rtp.resourceID().getId().toString(), rtp.endToEndId());

    ExternalServiceLevel1CodeWrapperDto externalServiceLevel1CodeWrapperDto =
        new ExternalServiceLevel1CodeWrapperDto();
    ...
    PaymentTypeInformation26EPC25922V30DS02Dto paymentTypeInformation26EPC25922V30DS02Dto =
        new PaymentTypeInformation26EPC25922V30DS02Dto(
    ...
    activeOrHistoricCurrencyAndAmountEPC25922V30DS02WrapperDto.setInstdAmt(
        rtp.amount().movePointLeft(2));

    Max35TextWrapperDto cdtMax35TextWrapperDto = new Max35TextWrapperDto();
    cdtMax35TextWrapperDto.setPrtry("LEI"); // FIXED

    GenericFinancialIdentification1Dto genericFinancialIdentification1Dto =
    ...
    FinancialInstitutionIdentification18EPC25922V30DS02Dto
        financialInstitutionIdentification18EPC25922V30DS02Dto =
            new FinancialInstitutionIdentification18EPC25922V30DS02Dto();
    financialInstitutionIdentification18EPC25922V30DS02Dto.setOthr(
        genericFinancialIdentification1Dto);

    BranchAndFinancialInstitutionIdentification6EPC25922V30DS02Dto
        cdtBranchAndFinancialInstitutionIdentification6EPC25922V30DS02Dto =
            new BranchAndFinancialInstitutionIdentification6EPC25922V30DS02Dto();
    cdtBranchAndFinancialInstitutionIdentification6EPC25922V30DS02Dto.setFinInstnId(
        financialInstitutionIdentification18EPC25922V30DS02Dto);

    ExternalOrganisationIdentification1CodeEPC25922V30DS022WrapperDto
        externalOrganisationIdentification1CodeEPC25922V30DS022WrapperDto =
            new ExternalOrganisationIdentification1CodeEPC25922V30DS022WrapperDto();
    externalOrganisationIdentification1CodeEPC25922V30DS022WrapperDto.setCd(
        ExternalOrganisationIdentification1CodeEPC25922V30DS022Dto.BOID);

    GenericOrganisationIdentification1EPC25922V30DS022Dto
        genericOrganisationIdentification1EPC25922V30DS022Dto =
            new GenericOrganisationIdentification1EPC25922V30DS022Dto();
    genericOrganisationIdentification1EPC25922V30DS022Dto.setId(rtp.payeeId());
    genericOrganisationIdentification1EPC25922V30DS022Dto.setSchmeNm(
        externalOrganisationIdentification1CodeEPC25922V30DS022WrapperDto);

    List<GenericOrganisationIdentification1EPC25922V30DS022Dto>
        lGenericOrganisationIdentification1EPC25922V30DS022Dtos = new ArrayList<>();
    lGenericOrganisationIdentification1EPC25922V30DS022Dtos.add(
        genericOrganisationIdentification1EPC25922V30DS022Dto);

    OrganisationIdentification29EPC25922V30DS022Dto
        organisationIdentification29EPC25922V30DS022Dto =
            new OrganisationIdentification29EPC25922V30DS022Dto();

    organisationIdentification29EPC25922V30DS022Dto.setOthr(
        lGenericOrganisationIdentification1EPC25922V30DS022Dtos);

    OrganisationIdentification29EPC25922V30DS022WrapperDto
        organisationIdentification29EPC25922V30DS022WrapperDto =
            new OrganisationIdentification29EPC25922V30DS022WrapperDto();
    organisationIdentification29EPC25922V30DS022WrapperDto.setOrgId(
        organisationIdentification29EPC25922V30DS022Dto);

    PartyIdentification135EPC25922V30DS023Dto partyIdentification135EPC25922V30DS023Dto =
        new PartyIdentification135EPC25922V30DS023Dto();
    partyIdentification135EPC25922V30DS023Dto.setNm(rtp.payeeName());
    partyIdentification135EPC25922V30DS023Dto.setId(
        organisationIdentification29EPC25922V30DS022WrapperDto);
    ...
    CashAccount40EPC25922V30DS022Dto cashAccount40EPC25922V30DS022Dto =
        new CashAccount40EPC25922V30DS022Dto();
    cashAccount40EPC25922V30DS022Dto.setId(iban2007IdentifierWrapperDto);

    InstructionForCreditorAgent3EPC25922V30DS02Dto
        payTrxRefinstructionForCreditorAgent3EPC25922V30DS02Dto =
            new InstructionForCreditorAgent3EPC25922V30DS02Dto(rtp.payTrxRef());
    InstructionForCreditorAgent3EPC25922V30DS02Dto
        flgConfRefinstructionForCreditorAgent3EPC25922V30DS02Dto =
            new InstructionForCreditorAgent3EPC25922V30DS02Dto(rtp.flgConf());

    List<InstructionForCreditorAgent3EPC25922V30DS02Dto>
        lInstructionForCreditorAgent3EPC25922V30DS02Dtos = new ArrayList<>();
    lInstructionForCreditorAgent3EPC25922V30DS02Dtos.add(
        payTrxRefinstructionForCreditorAgent3EPC25922V30DS02Dto);
    lInstructionForCreditorAgent3EPC25922V30DS02Dtos.add(
        flgConfRefinstructionForCreditorAgent3EPC25922V30DS02Dto);
    ...
    RemittanceInformation21EPC25922V30DS02Dto remittanceInformation21EPC25922V30DS02Dto =
        new RemittanceInformation21EPC25922V30DS02Dto();
    remittanceInformation21EPC25922V30DS02Dto.setUstrd(lUstrd);

    CreditTransferTransaction57EPC25922V30DS02Dto creditTransferTransaction57EPC25922V30DS02Dto =
        new CreditTransferTransaction57EPC25922V30DS02Dto();
    creditTransferTransaction57EPC25922V30DS02Dto.setPmtId(
        paymentIdentification6EPC25922V30DS02Dto);
    creditTransferTransaction57EPC25922V30DS02Dto.setPmtTpInf(
        paymentTypeInformation26EPC25922V30DS02Dto);
    creditTransferTransaction57EPC25922V30DS02Dto.setAmt(
        activeOrHistoricCurrencyAndAmountEPC25922V30DS02WrapperDto);
    creditTransferTransaction57EPC25922V30DS02Dto.setChrgBr(ChargeBearerType1CodeDto.SLEV); // FIXED
    creditTransferTransaction57EPC25922V30DS02Dto.setCdtrAgt(
        cdtBranchAndFinancialInstitutionIdentification6EPC25922V30DS02Dto);
    creditTransferTransaction57EPC25922V30DS02Dto.setCdtr(
    ...
    creditTransferTransaction57EPC25922V30DS02Dto.instrForCdtrAgt(
        lInstructionForCreditorAgent3EPC25922V30DS02Dtos);
    creditTransferTransaction57EPC25922V30DS02Dto.setRmtInf(
        remittanceInformation21EPC25922V30DS02Dto);

    List<CreditTransferTransaction57EPC25922V30DS02Dto>
        lCreditTransferTransaction57EPC25922V30DS02Dtos = new ArrayList<>();
    lCreditTransferTransaction57EPC25922V30DS02Dtos.add(
        creditTransferTransaction57EPC25922V30DS02Dto);

    PaymentInstruction42EPC25922V30DS02Dto paymentInstruction42EPC25922V30DS02Dto =
        new PaymentInstruction42EPC25922V30DS02Dto();
    ...
    paymentInstruction42EPC25922V30DS02Dto.setDbtrAgt(
        dbtBranchAndFinancialInstitutionIdentification6EPC25922V30DS02Dto);
    paymentInstruction42EPC25922V30DS02Dto.setCdtTrfTx(
        lCreditTransferTransaction57EPC25922V30DS02Dtos);

    List<PaymentInstruction42EPC25922V30DS02Dto> listPaymentInstruction42EPC25922V30DS02Dto =
        new ArrayList<>();
    ...
    CreditorPaymentActivationRequestV10EPC25922V30DS02Dto
        creditorPaymentActivationRequestV10EPC25922V30DS02Dto =
            new CreditorPaymentActivationRequestV10EPC25922V30DS02Dto();
    creditorPaymentActivationRequestV10EPC25922V30DS02Dto.setGrpHdr(
        groupHeader105EPC25922V30DS02Dto);
    creditorPaymentActivationRequestV10EPC25922V30DS02Dto.setPmtInf(
        listPaymentInstruction42EPC25922V30DS02Dto);

    DocumentEPC25922V30DS02Dto documentEPC25922V30DS02Dto = new DocumentEPC25922V30DS02Dto();
    documentEPC25922V30DS02Dto.setCdtrPmtActvtnReq(
        creditorPaymentActivationRequestV10EPC25922V30DS02Dto);

    sepaRequestToPayRequestResourceDto.setCallbackUrl(
        URI.create("http://spsrtp.api.cstar.pagopa.it")); // FIXED
